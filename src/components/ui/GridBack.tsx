...
export function GridBack() {
  return (
    <div className="absolute top-0 left-0 flex h-dvh w-full items-center justify-center bg-background dark:bg-background">
      <div
        className={cn(
          "absolute inset-0",
          ...
          "dark:[background-image:linear-gradient(to_right,var(--border)_1px,transparent_1px),linear-gradient(to_bottom,var(--border)_1px,transparent_1px)]",
        )}
      />
