...
const Services = () => {
    return (
        <section id="services" className="w-full py-20 px-4 md:px-8 lg:px-16">
...
const Card = ({
    ...
    return (
       ...
       dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative lg:h-[25rem] rounded-3xl cursor-pointer" // ضفت cursor-pointer
            style={{
        ...
        >
            ...
            <div className="relative z-20 px-10">
                ...
                <h2
                    ...
                    ${hovered ? "text-white opacity-100 -translate-y-2" : "opacity-0"}
                    `}
                >
                    {title}
                </h2>
